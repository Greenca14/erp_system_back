...
class Specification(models.Model):
    ...
    company = models.ForeignKey(Company, on_delete=models.CASCADE, verbose_name="Компания-заказчик")

    @property
    def total_no_vat(self):
        """Сумма всех групп без НДС (п. 2.2.5.6)"""
...
class StudyGroup(models.Model):
    ...
    # Фиксация цены на момент создания (ТЗ 2.2.2**)
    ...
    def average_progress(self):
        """Средний прогресс по группе (п. 2.2.3.9)"""
    ...
    def save(self, *args, **kwargs):
        ...
        # 2. Логика расчета стоимости (п. 3.2)
...
class GroupParticipant(models.Model):
    ...
    participant = models.ForeignKey(Participant, on_delete=models.CASCADE, verbose_name="Сотрудник")
